...
if ($_SERVER[HTTP_REFERER] == "http://smyrnabrasil.com.br/contato/" ||
	$_SERVER[HTTP_REFERER] == "http://smyrnabrasil.com.br/seja_distribuidor/" ||
 {
    ...
    $mailer->Username = 'kaique@380volts.com.br'; //Informe o e-mai o completo
    ...
    $mailer->From = 'kaique@380volts.com.br'; //Obrigatório ser a mesma caixa postal indicada em "username"
    $mailer->AddAddress('contato@graficaformacerta.com.br'); //Destinatários
    ...
    Telefone: $telefone
		Assunto: $assunto
    Serviço: $servico
    Descrição do material: $mensagem";
    if (!$mailer->Send()) {
